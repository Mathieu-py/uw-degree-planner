...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  icon: "p-1 text-zinc-500 hover:text-zinc-950 dark:hover:text-zinc-50 hover:bg-zinc-100 dark:hover:bg-zinc-800",
};
...
const SIZES: Record<ButtonSize, { padding: string; text: string }> = {
  ...
  // for tight inline confirms (PlansSidebar's delete row), sm for compact
